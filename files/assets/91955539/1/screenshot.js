...
Screenshot.attributes.add('refCameraEntity', {
    type: 'entity', 
    description: 'The reference camera so clear color can be matched'
});
...
Screenshot.prototype.initialize = function () {
    ...
    var onTakeScreenshot = function () {
        this.cameraEntity.camera.clearColor = this.refCameraEntity.camera.clearColor;
